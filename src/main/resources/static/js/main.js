    ...
    await fetchUser.getUser(id)
        ...
        .then(user => {
            let modalBody =
                ...
                '<input type="password" class="form-control" value="' + user.password + '" id="passwordEdit" placeholder="Password"/>' +
                '</div>' +
...
//                     </div>
                ...
                '<select class="custom-select" value="' + user.roles + '" id="rolesIdEdit" name="rolesId" multiple>' +
